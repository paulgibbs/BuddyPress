...
%6$s', 'buddypress' ),
					...
					bp_send_email( 'settings-verify-email-change', $user_email, sprintf( __( '[%s] Verify your new email address', 'buddypress' ), wp_specialchars_decode( bp_get_site_name() ) ), $content );
